    ...
    constructor(options, element) {
            ...
            if (!scriptName && !animationObject) {
                ...
                if (typeof scriptName === 'string' && !animationObject) {
                    if (this.spriteSheet.animations[scriptName]) {
                        ...
                        animationObject = Object.assign({}, playheadDefaults, { script: this.spriteSheet.animations[scriptName] });
                    }
                    else {
                ...
                if (animationObject) {
                    ...
                    this.playhead = Object.assign({}, playheadDefaults, { script: this.spriteSheet.animations.all }, animationObject);
                }
            }
        ...
        this.loadSpriteSheet = () => {
            ...
            imageLoaded(preload, () => {
                ...
                this.playhead = Object.assign({}, playheadDefaults, animationObject);
                // Starting sprite?
