(function (global, factory) {
  ...
  function Spriteling(options) {
    ...
    this.play = function (animationObject) {
      // Not yet loaded, wait...
      if (!_this._internal.loaded) {
        setTimeout(function () {
          _this.play(animationObject);
        }, 50);
        return false;
      }
      ...
      if ((typeof animationObject === 'undefined' ? 'undefined' : _typeof(animationObject)) === 'object') {
        if (typeof animationObject.script === 'string') {
          ...
          animationObject.script = _this._internal.animations[animationObject.script];
        }
      ...
      if (typeof _this._playhead.onPlay === 'function') {
        _this._.playhead.onPlay.call($element.data('spriteAnimator'));
      }
    };
